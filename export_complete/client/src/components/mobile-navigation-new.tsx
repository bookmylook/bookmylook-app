...
import { Calendar, User, Menu, ShoppingBag, Shield, Info, Mail, HelpCircle, FileText, Share2, History, LayoutGrid, Sun, Moon, Monitor, Settings, Briefcase, CalendarCheck, Star, LogOut, Home } from 'lucide-react';
...
export function MobileNavigationNew() {
  ...
  const navigationItems = isProvider 
    ...
    : isAuthenticated
    ? [
        // Authenticated client navigation - Home button first for easy navigation
    ...
    : [
        // Unauthenticated client navigation - Home button first
        { icon: Home, label: 'Home', href: '/', onClick: null },
        { icon: ShoppingBag, label: 'Services', href: '/providers', onClick: null },
        { icon: Calendar, label: 'Book Now', href: '/booking', onClick: null },
