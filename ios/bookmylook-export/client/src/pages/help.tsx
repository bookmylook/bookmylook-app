...
export default function Help() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We accept multiple payment methods: 1) Pay Now - Pay online during booking using UPI (PhonePe, GPay, Paytm, BHIM), cards, or net banking. 2) Pay at Salon - Scan the QR code at the salon after your service for digital payment. 3) Cash - Pay cash directly at the salon."
    },
    {
