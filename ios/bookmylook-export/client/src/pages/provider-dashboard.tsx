...
import { Calendar, User, Home, CalendarDays, CheckCircle, X, Settings, Trash2, Edit, LogOut, Clock } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center space-x-2 mb-6">
          ...
          <Button
            ...
            variant={selectedDate.toDateString() === addDays(new Date(), 1).toDateString() ? "default" : "outline"}
            size="sm"
            className="text-sm"
          >
            Tomorrow
        ...
        {provider?.id && (
          <Card className="mb-6">
            ...
            <CardContent>
              <TimeSlotGrid providerId={provider.id} selectedDate={selectedDate} />
            </CardContent>
          </Card>
        )}
