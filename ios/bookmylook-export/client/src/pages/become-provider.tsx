...
const createProviderFormSchema = (isEditMode: boolean) => z.object({
  ...
  // Bank account details for receiving payouts (97% of booking amount)
  bankName: z.string().min(1, "Bank name is required"),
  accountHolderName: z.string().min(1, "Account holder name is required"),
  accountNumber: z.string().min(8, "Valid account number required").max(18, "Account number too long"),
  ifscCode: z.string().length(11, "IFSC code must be 11 characters").regex(/^[A-Z]{4}0[A-Z0-9]{6}$/, "Invalid IFSC code format"),
  panNumber: z.string().length(10, "PAN must be 10 characters").regex(/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/, "Invalid PAN format (e.g., ABCDE1234F)"),
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200 mt-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="text-lg font-semibold text-green-800">Bank Account Details (For Receiving Payments)</h4>
                    </div>
                    <p className="text-sm text-green-700 bg-green-100 p-3 rounded">
                      💰 You'll receive <strong>100% of your service price</strong> directly to this account after each booking.
                    </p>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>PAN Number (For Tax Compliance)</FormLabel>
                          <FormControl>
                            <Input 
                          ...
                          <FormMessage />
                          <p className="text-xs text-gray-600">Required for income tax reporting and verification</p>
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>UPI ID (For Direct UPI Payments) <span className="text-green-600 text-xs">Optional</span></FormLabel>
                          <FormControl>
                            <Input 
                          ...
                          <FormMessage />
                          <p className="text-xs text-gray-600">Clients can pay directly via PhonePe/GPay/Paytm if you add your UPI ID</p>
                        </FormItem>
                      )}
                    />
                  </div>
